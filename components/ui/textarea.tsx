...
export function Textarea({
  ...
  return (
    <div className="flex flex-col gap-2">
      <label htmlFor={textareaId} className="text-text-heading text-[length:var(--font-size-3)]">
        {label}
      ...
      <textarea
        ...
        className={cn(
          "w-full resize-y rounded-radius-md border border-border-default bg-background-input px-spacing-20 py-3 text-text-body-text",
